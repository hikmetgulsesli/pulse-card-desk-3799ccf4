...
- Pulse Card Desk turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny one-page utility called Pulse Card Desk. It should show three compact cards, a refresh icon button, and save the selected card in local state. Keep it simple.
...
- Status Utility - Pulse Card Desk

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Status Utility - Pulse Card Desk
